...
public class Sodium {
  ...
  public static int crypto_kdf_derive_from_key(byte[] subkey, int subkey_len, int subkey_id, byte[] ctx, short[] key) {
    return SodiumJNI.crypto_kdf_derive_from_key(subkey, subkey_len, subkey_id, ctx, key);
  }

  public static void crypto_kdf_keygen(short[] k) {
    SodiumJNI.crypto_kdf_keygen(k);
  }
