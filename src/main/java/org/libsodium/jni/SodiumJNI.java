...
public class SodiumJNI {
  ...
  public final static native int crypto_kdf_derive_from_key(byte[] jarg1, int jarg2, int jarg3, byte[] jarg4, short[] jarg5);
  public final static native void crypto_kdf_keygen(short[] jarg1);
